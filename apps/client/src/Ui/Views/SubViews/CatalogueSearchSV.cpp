#include "CatalogueSearchSV.hpp"

CatalogueSearchSV::CatalogueSearchSV(QWidget *parent) : QWidget(parent) {
    setupUI();
}

void CatalogueSearchSV::setupUI() {
    std::cout << "[CatalogueSearchSV::setupUI] Setting up UI" << std::endl;
